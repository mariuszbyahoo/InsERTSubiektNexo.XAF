...
namespace InsERTSubiektNexo.XAF.Module.BusinessObjects
{
    [DomainComponent]
    [DefaultClassOptions]
    ...
    public class Asortyment : InsERT.Moria.ModelDanych.Asortyment, IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
